...
import msl.qa.screens.MainScreen;
...
public class WikiSearchTest extends TestBase {
  ...
  private final MainScreen ms = new MainScreen();

  @Tag("smoke")
  @Test
  void successfulOpenArticleTest() {
    String javaIsland = "Island and region in Indonesia";

    back();

    ms.activateSearchCard()
            .activateSearchField()
            .search("Java")
            .openedFirstSearchResults(javaIsland)
            .checkThatArticleOpend();
  }

  //@Tag("smoke")
  @Test
  void successfulSearchWithScreenObjectTest() {
    back();
  ...
  @Test
  void successfulSearchWithStepsTest(){
    back();
